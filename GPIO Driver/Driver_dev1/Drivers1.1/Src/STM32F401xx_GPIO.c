...
void GPIO_Init(GPIO_Handle_t *pGPIOHandle)
{
	...
	uint8_t value = GPIO_BASE_ADDR_TO_CODE(pGPIOHandle->pGPIOx);
	SYSCFGEN_PCLK_EN();
	SYSCFG->SYSCFG_EXTICR[temp1] = value <<(4*temp2);
	...
	// Non-interrupt mode
	temp = (pGPIOHandle->GPIO_PinConfig.GPIO_PinPuPdCtrl
			<< (2 * pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber));
	...
	// Non-interrupt mode
	temp = (pGPIOHandle->GPIO_PinConfig.GPIO_PinOptType
			<< (2 * pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber));
